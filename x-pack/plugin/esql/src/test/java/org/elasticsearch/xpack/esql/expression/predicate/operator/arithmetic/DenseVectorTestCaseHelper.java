    ...
    static List<TestCaseSupplier> denseVectorScalarCases(
        ...
        suppliers.add(new TestCaseSupplier(List.of(DENSE_VECTOR, DataType.INTEGER), () -> {
            ...
            return new TestCaseSupplier.TestCase(
                ...
                "DenseVectorsScalarEvaluator[lhs=Attribute[channel=0], rhs=" + (double) scalar + "]",
                DENSE_VECTOR,
                equalTo(expected)
            );
        }));
        ...
        suppliers.add(new TestCaseSupplier(List.of(DataType.INTEGER, DENSE_VECTOR), () -> {
            ...
            return new TestCaseSupplier.TestCase(
                List.of(
                 ...
                 "DenseVectorsScalarEvaluator[lhs=" + (double) scalar + ", rhs=Attribute[channel=0], opName=" + opName + "]",
                DENSE_VECTOR,
                equalTo(expected)
            );
        }));
        ...
        suppliers.add(new TestCaseSupplier(List.of(DENSE_VECTOR, DataType.LONG), () -> {
            ...
            return new TestCaseSupplier.TestCase(
                ...
                "DenseVectorsScalarEvaluator[lhs=Attribute[channel=0], rhs=" + (double) scalar + ", opName=" + opName + "]",
                DENSE_VECTOR,
                equalTo(expected)
            );
        }));
        ...
        suppliers.add(new TestCaseSupplier(List.of(DENSE_VECTOR, DataType.DOUBLE), () -> {
            ...
            return new TestCaseSupplier.TestCase(
                ...
                "DenseVectorsScalarEvaluator[lhs=Attribute[channel=0], rhs=" + scalar + ", opName=" + opName + "]",
                DENSE_VECTOR,
                equalTo(expected)
            );
        }));
        ...
        suppliers.add(new TestCaseSupplier(List.of(DataType.DOUBLE, DENSE_VECTOR), () -> {
            ...
            return new TestCaseSupplier.TestCase(
                ...
                "DenseVectorsScalarEvaluator[lhs=" + scalar + ", rhs=Attribute[channel=0], opName=" + opName + "]",
                DENSE_VECTOR,
                equalTo(expected)
            );
        }));
